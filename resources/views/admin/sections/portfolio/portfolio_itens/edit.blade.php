...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Editar Itens do Portfólio</h1>
        </div>
        <div class="section-body">
            <p class="section-lead">
                Nesta página, você pode Editar Itens do Portfólio.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Editar Itens do Portfólio</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.portfolio-itens.update', $portfolioItem->title) }}" method="POST"
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#image-preview').css({
                'background-image': 'url("{{ optional($portfolioItem)->image ? asset($portfolioItem->image) : '' }}")',
