...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Cadastrar Itens do Portfólio</h1>
        </div>
        <div class="section-body">
            <p class="section-lead">
                Nesta página, você pode Cadastrar Itens do Portfólio.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Cadastrar Itens do Portfólio</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.portfolio-itens.store') }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea style="height: 100px" class="form-control" name="description">{{ old('description', $portfolioItem->description ?? '') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
