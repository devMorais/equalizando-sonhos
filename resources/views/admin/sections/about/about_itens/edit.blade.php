...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Editar Itens da Seção Sobre</h1>
        </div>
        <div class="section-body">
            <h2 class="section-title">Editar Item Seção Sobre</h2>
            <p class="section-lead">
                Nesta página você pode Editar itens à seção Sobre do site.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.about-itens.update', $aboutItens->id) }}" method="POST"
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <label class="custom-switch mt-2">
                                            <input type="checkbox" name="is_disabled" class="custom-switch-input"
                                                {{ old('is_disabled', $aboutItens->is_disabled ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="title"
                                            value="{{ old('title', $aboutItens->title ?? '') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="url" class="form-control" name="url"
                                            value="	{{ old('url', $aboutItens->url ?? '') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Descrição</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea style="height: 100px" class="form-control" name="description">{{ old('description', $aboutItens->description ?? '') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-info" data-unselected-class="btn-primary"
                                            ...
                                            data-icon="{{ old('icon', $aboutItens->icon ?? 'fas fa-icons') }}"
                                            role="iconpicker">
                                        </button>
                                    </div>
                                </div>
