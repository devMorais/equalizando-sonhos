...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Cadastrar Itens da Seção de Serviço</h1>
        </div>
        <div class="section-body">
            <h2 class="section-title">Adicionar Item à Seção de Serviço</h2>
            <p class="section-lead">
                Nesta página você pode adicionar novos itens à Seção de Serviço.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Cadastrar Informações de Seção de Serviço</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.service-itens.store') }}" method="POST"
