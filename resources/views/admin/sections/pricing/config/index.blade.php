...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Editar Configuração da Seção Planos e Preços</h1>
        </div>
        <div class="section-body">
            <h2 class="section-title">Editar Seção Principal</h2>
            <p class="section-lead">
                Nesta página você pode Editar Configuração da Planos e Preços.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Editar Configuração da Seção Planos e Preços</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.pricing-config.update', 1) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <label class="custom-switch mt-2">
                                            <input type="checkbox" name="is_disabled" class="custom-switch-input"
                                                {{ old('is_disabled', $pricingConfig->is_disabled ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="title"
                                            value="{{ old('title', $pricingConfig->title ?? '') }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Descrição</label>
                                    <div class="col-sm-12 col-md-7">
                                        <textarea style="height: 100px" class="form-control" name="description">{{ old('description', $pricingConfig->description ?? '') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
