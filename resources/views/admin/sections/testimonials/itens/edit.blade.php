...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Editar depoimento</h2>
            <p class="section-lead">
                Nesta página você pode editar as informações do depoimento.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Editar Informações do depoimento</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.testimonials.update', $testimonial->id) }}" method="POST"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea style="height: 100px" class="form-control" name="testimonial">{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
