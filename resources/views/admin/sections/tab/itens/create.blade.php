...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Cadastrar Itens das guias</h2>
            <p class="section-lead">
                Nesta página você pode cadastrar as informações dos itens de guias.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Cadastrar Informações dos itens de guias.</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.tab-item.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
