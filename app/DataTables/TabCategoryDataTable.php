...
class TabCategoryDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                <a href="' . route('admin.tab-category.edit', $query->id) . '" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                <a href="' . route('admin.tab-category.destroy', $query->id) . '" class="delete-item btn btn-sm btn-danger "><i class="fas fa-trash"></i></a>
            </div>';
            })
     ...
     */
    public function query(TabCategory $model): QueryBuilder
    {
    ...
    {
        return [
            Column::make('id')->width(40)->addClass('text-left')->title('ID'),
            Column::make('title')->width(100)->addClass('text-center')->title('Título'),
            Column::make('icon')->width(100)->addClass('text-center')->title('Ícone'),
    ...
    {
        return 'TabCategory_' . date('YmdHis');
    }
}
