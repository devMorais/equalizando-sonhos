        ...
        (X.register = t =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var a = e.split("."), o = lt, i = 0, l = a.length;
                        i < l;
                        i++
                    ) {
                        var s,
